    ...
    public partial class init : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_doctorOnLeaves", x => x.LeaveId);
                    table.ForeignKey(
                        name: "FK_doctorOnLeaves_doctors_DoctorId",
                        column: x => x.DoctorId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PatientId = table.Column<int>(type: "int", nullable: false),
                    DoctorId = table.Column<int>(type: "int", nullable: false),
                    Decease = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    CreatedDate = table.Column<DateTime>(type: "datetime2", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PrescriptionModelPrescriptionId = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_prescribedMedicines", x => x.Id);
                    table.ForeignKey(
                        name: "FK_prescribedMedicines_prescriptions_PrescriptionModelPrescriptionId",
                        column: x => x.PrescriptionModelPrescriptionId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_doctorOnLeaves_DoctorId",
                table: "doctorOnLeaves",
                column: "DoctorId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_prescribedMedicines_PrescriptionModelPrescriptionId",
                table: "prescribedMedicines",
                column: "PrescriptionModelPrescriptionId");
